...
# sphinx-quickstart on Wed Sep 18 08:46:39 2013.
#
...
copyright = u'2013, Rob Hudson and other contributors'
...
latex_documents = [
  ('index', 'DjangoDebugToolbar.tex', u'Django Debug Toolbar Documentation',
   u'Rob Hudson and other contributors', 'manual'),
]
...
man_pages = [
    ('index', 'djangodebugtoolbar', u'Django Debug Toolbar Documentation',
     [u'Rob Hudson and other contributors'], 1)
]
...
texinfo_documents = [
  ('index', 'DjangoDebugToolbar', u'Django Debug Toolbar Documentation',
   u'Rob Hudson and other contributors', 'DjangoDebugToolbar', 'One line description of project.',
   'Miscellaneous'),
]
